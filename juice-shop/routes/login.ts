...
export function login () {
  ...
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    models.sequelize.query(`SELECT * FROM Users WHERE email = $email AND password = $pass AND deletedAt IS NULL`,{bind:{email: req.body.email, pass: security.hash(req.body.password)},model: UserModel, plain: true})//vuln-code-snippet vuln-line loginAdminChallenge loginBenderChallenge loginJimChallenge
